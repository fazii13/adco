...
const AboutTestimonials = () => {
  ...
  return (
    <section className="about-us-testimonial-area">
            ...
            <div className="row">
              <div className="col-lg-8 mx-auto">
                ...
                <div className="testimonial-info text-center">
                  <h4 className="title">Cameron Williamson</h4>
                  ...
                  <p>
                    Et nunc purus purus egestas. Nisi ultrices morbi dui placerat
                    nisi enim pharetra. Quis volutpat potenti vitae faucibus
                    suscipit sapien vulputat Et nunc purus purus suscipit sapien
                    vulputat Et nunc purus purus
                  </p>
                </div>
              </div>
            </div>
